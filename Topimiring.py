...
def login():
	try:
		...
		try:
			...
			li = 'INTERNET LOL, PERIKSA & COBA LAGI !'
...
def menu(name,id):
	...
	print('')
	if _____lexus__ygy_____ in ['01','1']:
		dump_massal()
	elif _____lexus__ygy_____ in ['02','2']:
	    dump_public()
	elif _____lexus__syihab_____ in ['03','3']:
	    cek_opsi()
	elif _____lexus__syihab_____ in ['04','4']:
	    result()
	elif _____lexus__syihab_____ in ['05','5']:
	    doa_halal()
	elif _____lexus__syihab_____ in ['06','6']:
	     whatsapp()
	elif _____lexus__syihab_____ in ['07','7']:
	    akun_facebook()
	elif _____lexus__ygy_____ in ['Bot','BOT','bot']:
	    bot()
	elif _____lexus__ygy_____ in ['lainnya','Lainnya','LAINNYA']:
	    lainnya()
	elif _____lexus__ygy_____ in ['00','0']:
